...
const ProductItemListView = ({
  ...
  return (
    <div className="productItem p-1 shadow-lg rounded-md overflow-hidden border-[rgba(0,0,0,0.1)] border flex items-center">
      <div className="group imgWrapper w-[25%] h-[230px] overflow-hidden rounded-md relative">
        <Link to="/">
          <div className="img h-[230px] w-full overflow-hidden relative">
            <img
              src={img}
              alt={title}
      ...
      <div className="info p-3 px-8 py-4 w-[75%]">
        ...
        <h3 className="text-[18px] font-medium mt-3 mb-3 text-[rgba(0,0,0,0.9)]">
          <Link to="/">{title}</Link>
        </h3>
        ...
        <div className="mt-3">
            <Button className="btn-org flex gap-2"><BsCart3 className="text-[18px]"/>Add to Cart</Button>
        </div>
      </div>
    </div>
  );
